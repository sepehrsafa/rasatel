...
class Subscription(models.Model):
    ...
    planPrice = models.ForeignKey(PlanPrice,on_delete=models.CASCADE,related_name="subscriptions")
    userCard = models.ForeignKey(UserCard,on_delete=models.CASCADE,related_name="subscriptions")
    stripeId = models.CharField(max_length=200,blank=True)
...
class GoIPPort(models.Model):
    ...
    simCardNumber = PhoneNumberField()
