...
class PlanPrice(models.Model):
    ...
    activationPlanPrice = models.ForeignKey(
...
class GoIPPort(models.Model):
    ...
    goip = models.ForeignKey(
        "GoIP", on_delete=models.CASCADE, related_name="messageBox"
    )
    smsServer = models.ForeignKey(
        "SMSServer",
        on_delete=models.CASCADE,
        related_name="messageBox",
        null=True,
        blank=True,
    )
...
class MessageBox(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    goipPort = models.ForeignKey(
        "GoIPPort", on_delete=models.CASCADE, related_name="messageBox"
    )
...
class Message(models.Model):
    ...
    messageBox = models.ForeignKey(
        "MessageBox", on_delete=models.CASCADE, related_name="messages"
    )
...
class VoIP3CXAccount(models.Model):
    server = models.ForeignKey(
        VoIPServer, on_delete=models.CASCADE, related_name="accounts"
    )
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="voipAccounts"
    )
...
class DisplayField(models.Model):
    product = models.ForeignKey(
        Product, on_delete=models.CASCADE, related_name="displayField"
    )
